...
clean_test_type <- unlist(meta(raw_test, tag = "class"))
...
train_sp <- apply(X = dtm_train, MARGIN = 2L, FUN = factorize)
val_sp <- apply(X = dtm_val, MARGIN = 2L, FUN = factorize)
test_sp <- apply(X = dtm_test, MARGIN = 2L, FUN = factorize)
```
